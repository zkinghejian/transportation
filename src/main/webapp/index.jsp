...
<!--header-->
		...
		<nav class="navbar navbar-default">
			<div class="container">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand wow bounceIn animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;" href="index.html">Yueye</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hvr-bounce-to-bottom"><a href="#gallery" class="scroll">服务展示</a></li>
	...
	<div class="about" id="about">
		<div class="container">
			...
			<div class="col-md-8 about-right wow fadeInRight animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
				<h4>最优质的汽车服务，给你不一样的体验</h4>
				<p>品牌成立2000年，以为30000个客户提供优质服务</p>
			</div>
			<div class="clearfix"> </div>
		</div>	
	</div>
	...
	<div id="contact" class="contact-form pt-section">
		<div class="container">
			...
			<div class="col-md-5 contact-left wow fadeInRight animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
				<p>我们的联系方式：</p>
				<ul>
					<li><span></span>湖南省岳麓区创新中心</li>

					<li><span class="mail"></span><a href="123456@qq.com">123456@qq.com</a></li>
	...
	<div class="footer wow fadeInRight animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
		<div class="container">
			<p>zking &copy; 2018 <a target="_blank" href="#"></a></p>
		</div>
	</div>
	<!--//footer-->
